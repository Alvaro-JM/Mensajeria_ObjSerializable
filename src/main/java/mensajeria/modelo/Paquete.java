...
public class Paquete implements Serializable{
    ...
    public Paquete(int id_paquete, Date fecha_entrega, String direccion_destino, String telefono_destino, String direccion_origen, String telefono_origen, int repartidor, boolean activo) {
