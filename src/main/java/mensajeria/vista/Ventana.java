...
public class Ventana extends javax.swing.JFrame {
    ...
    private void jButton_empresa_aniadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_empresa_aniadirActionPerformed
        ...
        if (nombre_empresa.equals("") || cif.equals("") || director.equals("") || web.equals("")) {
            ...
            Empresa empresa = new Empresa(id_empresa, nombre_empresa, cif, director, web, true);
            aniadirEmpresa(empresa);
            cargarTablaEmpresa();
    ...
    private void jButton_empresa_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_empresa_borrarActionPerformed
        ...
        Iterator<Oficina> it_oficina = listaOficinas.iterator();
        while (it_oficina.hasNext()) {
            Oficina o = it_oficina.next();
            if (o.getEmpresa() == id_empresaEliminar) {
                datosAsociados = true;
            }
        }
    ...
    private void jButton_oficina_aniadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_oficina_aniadirActionPerformed
        ...
        if (direccion_oficina.equals("") || telefono_oficina.equals("") || email.equals("") || encargado.equals("")) {
            ...
            try {
                int empresa_seleccionada = jComboBox_oficina_empresa.getSelectedIndex();
                int empresa = listaEmpresasMostradas.get(empresa_seleccionada).getId_empresa();
                int id_oficina = listaOficinas.get(listaOficinas.size() - 1).getId_oficina() + 1;

                Oficina oficina = new Oficina(id_oficina, direccion_oficina, telefono_oficina, email, encargado, empresa, true);
                aniadirOficina(oficina);
                cargarTablaOficina();
    ...
    private void jButton_oficina_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_oficina_borrarActionPerformed
        ...
        boolean datosAsociados = false;
        Iterator<Repartidor> it_repartidor = listaRepartidores.iterator();
        while (it_repartidor.hasNext()) {
            Repartidor r = it_repartidor.next();
            if (r.getOficina() == id_oficinaEliminar) {
                datosAsociados = true;
            }
        }
        ...
        if (dni.equals("") || nombre_repartidor.equals("") || telefono_repartidor.equals("") || jTextField_repartidor_antiguedad.getText().equals("")) {
            ...
            try {
                ...
                if (antiguedad < 0) {
                    ...
                    Repartidor repartidor = new Repartidor(id_repartidor, dni, nombre_repartidor, telefono_repartidor, antiguedad, oficina, true);

                    aniadirRepartidor(repartidor);
    ...
    private void jButton_repartidor_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_repartidor_borrarActionPerformed
        ...
        boolean datosAsociados = false;
        Iterator<Paquete> it_paquete = listaPaquetes.iterator();
        while (it_paquete.hasNext()) {
            Paquete p = it_paquete.next();
            if (p.getRepartidor() == id_repartidorEliminar) {
                datosAsociados = true;
            }
        }
    ...
    private void jButton_paquete_aniadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_paquete_aniadirActionPerformed
        ...
        if (direccion_destino.equals("") || telefono_destino.equals("") || direccion_origen.equals("") || telefono_origen.equals("")) {
            ...
            try {
                ...
                Paquete paquete = new Paquete(id_paquete, fecha_entrega, direccion_destino,
                        telefono_destino, direccion_origen, telefono_origen, repartidor, true);

                aniadirPaquete(paquete);
                cargarTablaPaquete();
    ...
    private void desactivarModificarBorrar(){
        jButton_empresa_modificar.setEnabled(false);
        jButton_empresa_borrar.setEnabled(false);
    ...
    private void cargarListas() throws IOException, FileNotFoundException, ClassNotFoundException{
        empresaControlador = new EmpresaControlador();
    ...
    public void aniadirEmpresa(Empresa empresa){
    ...
    public void eliminarEmpresa(int id_empresaEliminar){
    ...
    private void aniadirOficina(Oficina oficina) {
        listaOficinas.add(oficina);
        listaOficinasMostradas.add(oficina);
    }
    
    private void modificarOficina(int filaSeleccionada, String direccion_oficina, String telefono_oficina, String email, String encargado, int empresa){
    ...
    private void eliminarOficina(int id_oficinaEliminar){
    ...
    private void aniadirRepartidor(Repartidor repartidor) {
    ...
    private void eliminarRepartidor(int id_repartidorEliminar){
    ...
    private void aniadirPaquete(Paquete paquete) {
    ...
    private void eliminarPaquete(int id_paqueteEliminar){
